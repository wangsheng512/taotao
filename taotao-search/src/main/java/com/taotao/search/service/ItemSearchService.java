...
public class ItemSearchService {
	...
	public SearchResul search(String keywords, Integer page, Integer rows) throws SolrServerException {
		...
		return new SearchResul(queryResponse.getResults().getNumFound(), items);
	}
